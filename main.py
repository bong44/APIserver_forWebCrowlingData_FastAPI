...
if __name__ == "__main__":
    ...
    uvicorn.run("main:app",host="0.0.0.0",port=8443,reload=True, ssl_keyfile="/ssl/live/metabus.site/privkey.pem", ssl_certfile="/ssl/live/metabus.site/fullchain.pem")
